...
describe('api.zitat-service.de (end2end)', () => {
  ...
  it('invokes GET /v1/users?starting=Heiko', async () => {
    ...
    expect({
      ...
      users: fixtures.users.filter(
        user => user.login.toLowerCase() === 'heiko',
      ),
    }).to.eql(response.body);
  });
  it('invokes GET /v1/users?starting=cheesecake', async () => {
    const response = await client
      .get('/v1/users?starting=cheesecake')
      .expect(404);
    response.text.should.containEql('NotFoundError');
  });
  // incorrect requests
  ...
  it('invokes GET /v1/users?starting=abcdefghijklmnopqrst', async () => {
    const response = await client
      .get('/v1/users?starting=abcdefghijklmnopqrst')
      .expect(404);
    response.text.should.containEql('NotFoundError');
  });
  ...
  it('invokes GET /v1/users?starting=abcdefghijklmnopqrstu', async () => {
    const response = await client
      .get('/v1/users?starting=abcdefghijklmnopqrstu')
      .expect(400);
    response.text.should.containEql('BadRequestError');
  });
  ...
  it('invokes GET /v1/categories?language=de&page=100&size=1', async () => {
    const response = await client
      .get('/v1/categories?language=de&page=100&size=1')
      .expect(200);
    expect([
      {
        id: 276,
  ...
  it('invokes GET /v1/categories?language=es&page=120&size=1', async () => {
    const response = await client
      .get('/v1/categories?language=es&page=120&size=1')
      .expect(200);
    expect([
      {
        id: 293,
  ...
  it('invokes GET /v1/categories?language=ja&page=140&size=1', async () => {
    const response = await client
      .get('/v1/categories?language=ja&page=140&size=1')
      .expect(200);
    expect([
      {
        id: 213,
  ...
  it('invokes GET /v1/categories?language=uk&page=160&size=1', async () => {
    const response = await client
      .get('/v1/categories?language=uk&page=160&size=1')
      .expect(200);
    expect([
      {
        id: 517,
  ...
  it('invokes GET /v1/categories?starting=Ban', async () => {
    const response = await client
      .get('/v1/categories?starting=Ban')
      .expect(200);
    expect([
      {
        id: 557,
  ...
  it('invokes GET /v1/categories?language=de&starting=Fah', async () => {
    const response = await client
      .get('/v1/categories?language=de&starting=Fah')
      .expect(200);
    expect([
      {
        id: 410,
  ...
  it('invokes GET /v1/categories?language=de&starting=Fäh', async () => {
    const response = await client
      .get('/v1/categories?language=de&starting=' + encodeURIComponent('Fäh'))
      .expect(200);
    expect([
      {
        id: 410,
  ...
  it('invokes GET /v1/categories?language=es&starting=Áci', async () => {
    const response = await client
      .get('/v1/categories?language=es&starting=' + encodeURIComponent('Áci'))
      .expect(200);
    expect([
      {
        id: 428,
  ...
  it('invokes GET /v1/categories?language=es&starting=Aci', async () => {
    const response = await client
      .get('/v1/categories?language=es&starting=Aci')
      .expect(200);
    expect([
      {
        id: 428,
  ...
  it('invokes GET /v1/categories?language=ja&starting=おそ', async () => {
    const response = await client
      .get('/v1/categories?language=ja&starting=' + encodeURIComponent('おそ'))
      .expect(200);
    expect([
      {
        id: 457,
  ...
  it('invokes GET /v1/categories?language=ja&starting=アイブ', async () => {
    const response = await client
      .get(
        '/v1/categories?language=ja&starting=' + encodeURIComponent('アイブ'),
      )
      .expect(200);
    expect([
      {
  ...
  it('invokes GET /v1/categories?language=uk&starting=Іді', async () => {
    const response = await client
      .get('/v1/categories?language=uk&starting=' + encodeURIComponent('Іді'))
      .expect(200);
    expect([
      {
        id: 273,
  ...
  it('invokes GET /v1/categories?page=160&size=1', async () => {
    const response = await client
      .get('/v1/categories?page=160&size=1')
      .expect(200);
    expect([
      {
        id: 483,
  ...
  it('invokes GET /v1/categories?language=&page=160&size=1', async () => {
    const response = await client
      .get('/v1/categories?language=&page=160&size=1')
      .expect(400);
    response.text.should.containEql('BadRequestError');
  });
  it('invokes GET /v1/categories?language=XXX&page=160&size=1', async () => {
    const response = await client
      .get('/v1/categories?language=XXX&page=160&size=1')
      .expect(400);
    response.text.should.containEql('BadRequestError');
  });
  ...
  it('invokes GET /v1/categories?starting=abcdefghijklmnopqrst', async () => {
    const response = await client
      .get('/v1/categories?starting=abcdefghijklmnopqrst')
      .expect(404);
    response.text.should.containEql('NotFoundError');
  });
  // SQL injection, not more than 20 chars
  it('invokes GET /v1/categories?starting=abcdefghijklmnopqrstu', async () => {
    const response = await client
      .get('/v1/categories?starting=abcdefghijklmnopqrstu')
      .expect(400);
    response.text.should.containEql('BadRequestError');
  });
  // SQL injection, not starting with an apostrophe
  ...
  it('invokes GET /v1/authors?language=de&page=100&size=1', async () => {
    const response = await client
      .get('/v1/authors?language=de&page=100&size=1')
      .expect(200);
    expect([
      {
        authorId: 61,
  ...
  it('invokes GET /v1/authors?language=es&page=120&size=1', async () => {
    const response = await client
      .get('/v1/authors?language=es&page=120&size=1')
      .expect(200);
    expect([
      {
        authorId: 525,
  ...
  it('invokes GET /v1/authors?language=ja&page=140&size=1', async () => {
    const response = await client
      .get('/v1/authors?language=ja&page=140&size=1')
      .expect(200);
    expect([
      {
        authorId: 106,
  ...
  it('invokes GET /v1/authors?language=uk&page=160&size=1', async () => {
    const response = await client
      .get('/v1/authors?language=uk&page=160&size=1')
      .expect(200);
    expect([
      {
        authorId: 171,
  ...
  it('invokes GET /v1/authors?page=200&size=1', async () => {
    const response = await client
      .get('/v1/authors?page=200&size=1')
      .expect(200);
    expect({
      language: 'en',
      totalCount: 562,
  ...
  it('invokes GET /v1/authors?lastname=A&firstname=D&size=1', async () => {
    const response = await client
      .get('/v1/authors?lastname=A&firstname=D&size=1')
      .expect(200);
    expect([
      {
        authorId: 345,
  ...
  it('invokes GET /v1/authors?description=British%20actress', async () => {
    const response = await client
      .get('/v1/authors?description=British%20actress')
      .expect(200);
    expect([
      {
        authorId: 339,
    ...
    expect([
      {
        ...
        firstname: 'Henry',
        description:
          'US-American historian and cultural philosopher (1838 - 1918)',
  ...
  it('invokes GET /v1/authors?language=de&lfd=Adenauer,Konrad,Deutscher%20Politiker', async () => {
    const response = await client
      .get('/v1/authors?language=de&lfd=Adenauer,Konrad,Deutscher%20Politiker')
      .expect(200);
    expect([
      {
        authorId: 243,
  ...
  it('retrieves the first author entry and checks that lastname is set', async () => {
    const response = await client
      .get('/v1/authors?language=en&page=1&size=1')
      .expect(200);
  ...
  it('retrieves the the last author entry and checks that lastname is not set', async () => {
    ...
    response = await client
      .get(`/v1/authors?page=${totalCount}&size=1`)
      .expect(200);
    expect(response.body.authors).to.have.lengthOf(1);
  ...
  it('invokes GET /v1/authors?description=ZZZ', async () => {
    const response = await client
      .get('/v1/authors?description=ZZZ')
      .expect(404);
    response.text.should.containEql('NotFoundError');
  });
  // exact 20 chars are working, but does not find any user
  it('invokes GET /v1/authors?lastname=abcdefghijklmnopqrst', async () => {
    const response = await client
      .get('/v1/authors?lastname=abcdefghijklmnopqrst')
      .expect(404);
    response.text.should.containEql('NotFoundError');
  });
  // SQL injection, not more than 20 chars
  it('invokes GET /v1/authors?lastname=abcdefghijklmnopqrstu', async () => {
    const response = await client
      .get('/v1/authors?lastname=abcdefghijklmnopqrstu')
      .expect(400);
    response.text.should.containEql('BadRequestError');
  });
  // SQL injection, not starting with an apostrophe
  ...
  it('invokes GET /v1/authors?firstname=abcdefghijklmnopqrst', async () => {
    const response = await client
      .get('/v1/authors?firstname=abcdefghijklmnopqrst')
      .expect(404);
    response.text.should.containEql('NotFoundError');
  });
  // SQL injection, not more than 20 chars
  it('invokes GET /v1/authors?firstname=abcdefghijklmnopqrstu', async () => {
    const response = await client
      .get('/v1/authors?firstname=abcdefghijklmnopqrstu')
      .expect(400);
    response.text.should.containEql('BadRequestError');
  });
  // SQL injection, not starting with an apostrophe
  ...
  it('invokes GET /v1/authors?description=abcdefghijklmnopqrst', async () => {
    const response = await client
      .get('/v1/authors?description=abcdefghijklmnopqrst')
      .expect(404);
    response.text.should.containEql('NotFoundError');
  });
  // SQL injection, not more than 20 chars
  it('invokes GET /v1/authors?description=abcdefghijklmnopqrstu', async () => {
    const response = await client
      .get('/v1/authors?description=abcdefghijklmnopqrstu')
      .expect(400);
    response.text.should.containEql('BadRequestError');
  });
  // SQL injection, not starting with an apostrophe
  ...
  it('invokes GET /v1/authors?lfd=abcdefghijklmnopqrst,abcdefghijklmnopqrst,abcdefghijklmnopqrst', async () => {
    const response = await client
      .get(
        '/v1/authors?lfd=abcdefghijklmnopqrst,abcdefghijklmnopqrst,abcdefghijklmnopqrst',
      )
      .expect(404);
    response.text.should.containEql('NotFoundError');
  });
  ...
  it('invokes GET /v1/authors?lfd=abcdefghijklmnopqrstu', async () => {
    const response = await client
      .get('/v1/authors?lfd=abcdefghijklmnopqrstu')
      .expect(400);
    response.text.should.containEql('BadRequestError');
  });
  // SQL injection, not starting with an apostrophe
  ...
  it('invokes GET /v1/author?authorId=597&language=ja', async () => {
    const response = await client
      .get('/v1/author?authorId=597&language=ja')
      .expect(200);
    expect({
      author: {
        authorId: 597,
        ...
        firstname: '龍一',
        description:
          '日本の作曲家、ピアニスト、プロデューサー、俳優、モデル（1952年～2023年）',
  ...
  it('invokes GET /v1/author?authorId=597', async () => {
    ...
    expect({
      author: {
        ...
        firstname: 'Ryuichi',
        description:
          'Japanese composer, pianist, producer, actor and model (1952 - 2023)',
  ...
  it('invokes GET /v1/author?authorId=597&language=', async () => {
    const response = await client
      .get('/v1/author?authorId=597&language=')
      .expect(400);
    response.text.should.containEql('BadRequestError');
  });
  it('invokes GET /v1/author?authorId=597&language=XXX', async () => {
    const response = await client
      .get('/v1/author?authorId=597&language=XXX')
      .expect(400);
    response.text.should.containEql('BadRequestError');
  });
  ...
  it('invokes GET /v1/quote?authorId=601', async () => {
    ...
    expect({
      ...
      source:
        'Martha Graham Reflects on Her Art and a Life in Dance, The New York Times, 1985',
      sourceLink:
        'https://archive.nytimes.com/www.nytimes.com/library/arts/033185graham.html',
      authorId: 601,
  ...
  it('invokes GET /v1/quote?userId=97&language=de', async () => {
    const response = await client
      .get('/v1/quote?userId=97&language=de')
      .expect(200);
    expect({
  ...
  it('invokes GET /v1/quote?authorId=0&categoryId=16&userId=73&language=es', async () => {
    const response = await client
      .get('/v1/quote?authorId=0&categoryId=16&userId=73&language=es')
      .expect(200);
    expect({
  ...
  it('invokes GET /v1/quote?authorId=33&categoryId=501&language=de', async () => {
    const response = await client
      .get('/v1/quote?authorId=33&categoryId=501&language=de')
      .expect(200);
    expect({
  ...
  it('invokes GET /v1/quote_html?contentOnly=false', async () => {
    const response = await client
      .get('/v1/quote_html?contentOnly=false')
      .expect(200);
    response.text.should.containEql('<!DOCTYPE html>\n');
    response.text.should.containEql(
      '<div class="quote"><div class="quotation"><a href="',
  ...
  it('invokes GET /v1/quote_html?target=quote_window', async () => {
    const response = await client
      .get('/v1/quote_html?target=quote_window')
      .expect(200);
  ...
  it('invokes GET /v1/quote_html?authorId=0&categoryId=545&userId=85', async () => {
    const response = await client
      .get('/v1/quote_html?authorId=0&categoryId=545&userId=85')
      .expect(200);
    response.text.should.containEql(
      '<div class="quote"><div class="quotation"><a href="',
    );
  ...
  it('invokes GET /v1/quote_html?authorId=601', async () => {
    const response = await client
      .get('/v1/quote_html?authorId=601')
      .expect(200);
    response.text.should.containEql(
      `<!DOCTYPE html>
<html lang="en">
...
`,
  ...
  it('invokes GET /v1/quote_html?userId=97&language=de', async () => {
    const response = await client
      .get('/v1/quote_html?userId=97&language=de')
      .expect(200);
    response.text.should.containEql(
      `<!DOCTYPE html>
<html lang="de">
...
`,
  ...
  it('invokes GET /v1/quote_html?authorId=0&categoryId=16&userId=73&language=es', async () => {
    const response = await client
      .get('/v1/quote_html?authorId=0&categoryId=16&userId=73&language=es')
      .expect(200);
    response.text.should.containEql(
      `<!DOCTYPE html>
<html lang="es">
...
`,
  ...
  it('invokes GET /v1/quote_html?authorId=33&categoryId=501&language=de', async () => {
    const response = await client
      .get('/v1/quote_html?authorId=33&categoryId=501&language=de')
      .expect(200);
    response.text.should.containEql(
      `<!DOCTYPE html>
<html lang="de">
...
`,
  ...
  it('invokes GET /v1/quote_html?authorId=1.1', async () => {
    const response = await client
      .get('/v1/quote_html?authorId=1.1')
      .expect(400);
    response.text.should.containEql('BadRequestError');
  });
  ...
  it('invokes GET /v1/quote_html?authorId=1000', async () => {
    const response = await client
      .get('/v1/quote_html?authorId=1000')
      .expect(404);
    response.text.should.containEql('NotFoundError');
  });
  ...
  it('invokes GET /v1/quote_html?language=XXX', async () => {
    const response = await client
      .get('/v1/quote_html?language=XXX')
      .expect(400);
    response.text.should.containEql('BadRequestError');
  });
  // testing #1919 non-public quote with non-public category #623
